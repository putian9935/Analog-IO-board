...
void SPIClass::begin()
{
	...
	CCM_CBCMR = (CCM_CBCMR & ~(CCM_CBCMR_LPSPI_PODF_MASK | CCM_CBCMR_LPSPI_CLK_SEL_MASK)) |
		CCM_CBCMR_LPSPI_PODF(3) | CCM_CBCMR_LPSPI_CLK_SEL(1); // pg 714, 90MHz
		// CCM_CBCMR_LPSPI_PODF(1) | CCM_CBCMR_LPSPI_CLK_SEL(3); // pg 714, 99MHz, dead 
		// CCM_CBCMR_LPSPI_PODF(2) | CCM_CBCMR_LPSPI_CLK_SEL(1); // pg 714, 120MHz+90MHz, dead adc
		// CCM_CBCMR_LPSPI_PODF(2) | CCM_CBCMR_LPSPI_CLK_SEL(0); // pg 714, 110MHz, dead adc
		// CCM_CBCMR_LPSPI_PODF(1) | CCM_CBCMR_LPSPI_CLK_SEL(2); // pg 714, 132MHz, dead
